...
public class MonitorUtil {
	...
	public static SysMonitorInfo getSysMonitor() throws UnknownHostException {
		Runtime r = Runtime.getRuntime();
	    Properties props = System.getProperties();
	    InetAddress addr = InetAddress.getLocalHost();
	    Map<String, String> map = System.getenv();
	    
		SysMonitorInfo info = new SysMonitorInfo();
		...
		info.setJvmMaxMemory(""+r.maxMemory());
		info.setJvmName(props.getProperty("java.vm.name"));
		info.setJvmTotalMemory(""+r.totalMemory());
		info.setJvmVersion(props.getProperty("java.vm.version"));
