...
public class JasperUtils {
    ...
    public JasperUtils(HttpServletRequest request, HttpServletResponse response) {
        super();
     ...
     * @throws JRException
     */
    public void exportHtml(String jasperPath, Map<String, Object> parameters, String downloadName,
                           JRDataSource dataSource) throws JRException, IOException {
        //通过JasperFillManager工具进行填充报表，生成JasperPring文件
    ...
    public String createHtml(HttpServletResponse response, List<?> list, String jasperPath, String fileName,
        ...
        String path = WebPathUtils.getClassPath() + "/reportHtml" + folder + "/" + dpath;
    ...
    public void createExportDocument(DocType docType, String jasperPath, Map<String, Object> parameters, List<?> list,
        ...
        //加缓存
        JRFileVirtualizer virtualizer = new JRFileVirtualizer(2, WebPathUtils.getClassPath() + "/temp");
